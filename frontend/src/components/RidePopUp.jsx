    ...
    <div>
      ...
      <div className="flex justify-between items-center flex-col gap-2">
        ...
        <button
          ...
          className=" bg-gray-300 text-gray-700 font-semibold rounded-2xl p-3 px-10 mt-3"
        ...
        <button
          ...
          className=" bg-green-600 text-white font-semibold rounded-2xl  px-10 p-3 mt-5"
        >
          Accept
        </button>
        </div>
